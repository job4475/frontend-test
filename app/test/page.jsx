...
const switches = ['Reverse to original', 'Allow save changes', 'Allow print', 'Allow copy paste','Allow run macro', 'Insert Water Mark', 'Allow transfer owner','Allow convert to html','Allow convert to original file',];
const page = () => {
  ...
  return (
    <>
      ...
      <Box sx={{pl:6,pt:3}}>Share Document</Box>
      ...
      <TextField id="outlined-basic" label="Subject"size="small" variant="outlined" style={{width:"500px",paddingBottom:10}} 
      InputProps={{
        startAdornment: (
      ...
      <Box sx={{width: "500px",height: "250px",borderRadius: "10px",backgroundColor: "#F7F8F9",borderStyle: "dashed",
            borderWidth: "1px",borderColor: "#ccc",display:'flex',justifyContent:"center",alignItems:'center',flexDirection:'column'}}>
                ...
                <Button variant="contained"size="small" style={{background:'#48846B',textTransform:'capitalize'}}>Upload</Button>
        </Box>
      </Box>
      </Box>
      <Box sx={{display:'flex',flexDirection:'column'}}>
    ...
    />
      <Box> {switchChecked ? "*  For recipients using the FinalCode." : "*  For recipients who do not use the FinalCode."}</Box>
        </Box>
      ...
      <Box sx={{width: "500px",height: "345px",borderRadius: "10px",backgroundColor: "#FFFFFF",
  ...
  <Button variant="outlined"size="large" style={{ marginRight: "10px",textTransform:'capitalize' }}>Exit</Button>
