        ...
        <CustomBackground>
            <Box>
                <Box sx={{ background: '', width: '100%', mx: 'auto' }}>
                    <Box sx={{ textAlign: 'left', color: '#1F2939', fontSize: 20, fontWeight: '700'}}>Choose Authentication Method</Box>
                ...
                <Box sx={{ mt: '30px', flexDirection: 'column', gap: '10px', display: 'flex', alignItems: 'center' }}>
                    <Box onClick={handleImageClickMail} sx={{ background: '#F6F6F6', width: '100%', height: '100px', borderRadius: '12px', pl: '35px', display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '25px', boxShadow: isClickedMail ? 'inset 0 0 0 3px #84BAA1' : 'none', cursor: 'pointer' }}>
                    ...
                    <Box onClick={handleImageClickAut} sx={{ background: '#F6F6F6', width: '100%', height: '100px', borderRadius: '12px', pl: '35px', display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '25px', boxShadow: isClickedAut ? 'inset 0 0 0 3px #84BAA1' : 'none', cursor: 'pointer' }}>
