...
function index() {
  return (
    <Box sx={{mt:2,display:"flex"}}>
        ...
        <Box sx={{ml:2,width: "auto",height: "50px",padding: "5px 50px",border:"1px solid #84BAA1",background:"#84BAA1",display:"flex",justifyContent:"center",alignItems:"center",borderRadius:"6px"
