...
const columns = [
  ...
  { id: 'Approve', label: 'APPROVE', minWidth: 0, align: 'right' },

];

function createData(NameOFUser, Email, Department, Jobtitle, Approve) {
  return { NameOFUser, Email, Department, Jobtitle, Approve };
}

const rows = [
    createData('Kraiwit Bunchu', 'kraiwit1711@hotmail.com', 'Development & BI', 'UX/UI'),
    createData('Kraiwit Bunchu', 'kraiwit1711@hotmail.com', 'Development & BI', 'UX/UI'),
    createData('Kraiwit Bunchu', 'kraiwit1711@hotmail.com', 'Development & BI', 'UX/UI'),
    createData('Kraiwit Bunchu', 'kraiwit1711@hotmail.com', 'Development & BI', 'UX/UI'),
    createData('Kraiwit Bunchu', 'kraiwit1711@hotmail.com', 'Development & BI', 'UX/UI'),
