...
function Page() {
  ...
  return (
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column',width:'100%' }}>
        <Box sx={{  }}>
          <Box sx={{m:2,width:'90%',display: 'flex', alignItems: 'flex-start', justifyContent: 'center',flexDirection:'column'}} >
            <Box sx={{ fontSize: '15px' }}>Hello good morning <b>{state.emailconfirm?state.emailconfirm: state.email}</b> Welcome to ChicCRM registration process now you are in</Box>
            <Box sx={{ fontSize: '10px',mt:1 }}>After complete all infomation you will received email your password</Box>
          </Box>
        </Box>
      ...
      <Box >
        ...
        <Box sx={{ display: 'flex',flexDirection:'column' ,ml: 2 }}>
          <Box sx={{ m: '2%', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <Grid container rowGap={2}>
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mr: 5 }}>
                <Box sx={{ display: 'flex', alignItems: 'center'  }}>
                  ...
                  <TextField id="standard-basic" variant="standard"  value={state.alias} onChange={Handlecompany.Alias} sx={{ width: "150px" }} />
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  <Box sx={{ pt: 1.5, width: '150px', color: '#1F2939', fontWeight: '500',fontSize:"13px"  }}>Company name</Box>
                  <TextField id="standard-basic" variant="standard" value={state.companyname} onChange={Handlecompany.Companyname} sx={{ width: "150px" }} />
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  <Box sx={{ pt: 1.5, width: '150px', color: '#1F2939', fontWeight: '500',fontSize:"13px"  }}>No</Box>
                  <TextField id="standard-basic" variant="standard" value={state.no} onChange={Handlecompany.No} sx={{ width: "150px" }} />
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  <Box sx={{ pt: 1.5, width: '150px', color: '#1F2939', fontWeight: '500',fontSize:"13px"  }}>Street</Box>
                  <TextField id="standard-basic" variant="standard" value={state.street} onChange={Handlecompany.Street} sx={{ width: "150px" }} />
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  <Box sx={{ pt: 1.5, width: '150px', color: '#1F2939', fontWeight: '500',fontSize:"13px"  }}>Country</Box>
                  <Select id="standard-basic" variant="standard" value={state.country} onChange={Handlecompany.Country} sx={{ width: "150px" }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <Select labelId="tambon-select-label" variant="standard" id="tambon-select" value={state.selectedTambon} label="Tambon"
                    onChange={Handlecompany.handleTambonChange} sx={{ width: "150px" }} size='small'>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <TextField variant="standard" size='small' value={state.zipcode} InputProps={{ readOnly: true, }} sx={{ width: "150px" }} />
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  <Box sx={{ pt: 1.5, width: '150px', color: '#1F2939', fontWeight: '500',fontSize:"13px"  }}>Phone Number</Box>
                  <TextField id="standard-basic" variant="standard" inputProps={{ maxLength: 10, inputMode: 'numeric' }} value={state.phoneNumber} onChange={Handlecompany.phoneNumber} sx={{ width: "150px" }} />
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  <Box sx={{ pt: 1.5, width: '150px', color: '#1F2939', fontWeight: '500',fontSize:"13px"  }}>Google Maps</Box>
                  <TextField id="standard-basic" variant="standard" value={state.googlemaps} onChange={Handlecompany.GoogleMaps} sx={{ width: "150px" }} />
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  <Box sx={{ pt: 1.5, width: '150px', color: '#1F2939', fontWeight: '500',fontSize:"13px"  }}>Website</Box>
                  <TextField id="standard-basic" variant="standard" value={state.webSite} onChange={Handlecompany.webSite} sx={{ width: "150px" }} />
                </Box>
              </Box>
            </Grid>
          </Box>
      ...
      <Box sx={{ ml:2,mt:5, display:'flex',gap:'12px', }}>
