...
function page() {
 ...
 const HandleLogin = handlegovelify();
  return (
    <Box>
      <Box p={5} sx={{display: 'flex',flexDirection: 'column',background: 'width',width: '100%',height: 'auto',borderRadius: "15px",marginLeft: 'auto',mt: 1,boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)',justifyContent:'space-between'}}>
        <Box>
