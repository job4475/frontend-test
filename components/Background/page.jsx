...
const Layout = ({ children }) => {
    ...
    return (
        <Box display="flex" height="100vh" justifyContent="center" alignItems="center" bgcolor="#F7FAFB" px="70px" py="50px"  >
            ...
            <Box width="30%" maxWidth="500px" minWidth="400px" height="85%" maxHeight="550px" minHeight="480px" px="42px" py="30px" bgcolor="#fff" borderRadius="17px" display="flex" flexDirection="column" justifyContent="space-between" boxShadow="0px 0px 50px 8px rgba(0,0,0,0.05)" >
                {children}
            </Box>
        </Box>
    );
