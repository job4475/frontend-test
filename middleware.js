export function middleware(request) {
    ...
    && !request.nextUrl.pathname.startsWith('/ShareDocument')&& !request.nextUrl.pathname.startsWith('/Userlist')&& !request.nextUrl.pathname.startsWith('/ServiceRate')
    )  {
    ...
    && !request.nextUrl.pathname.startsWith('/Changepassword')&& !request.nextUrl.pathname.startsWith('/test') && !request.nextUrl.pathname.startsWith('/ServiceRate')
    ) {
